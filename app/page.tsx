      ...
      <main className="flex w-full min-h-screen">
        ...
        <section className="hidden md:flex md:w-1/2 pattern-bg relative items-center justify-center p-8 overflow-hidden min-h-screen">
          ...
          <div className="relative z-10 w-full max-w-lg text-white space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-white/80 leading-[24px] text-[16px] font-400">
                Kelola reservasi ruangan, peminjaman alat, dan absensi digital
                dalam satu platform terintegrasi. Dirancang untuk menunjang
                produktivitas riset dan akademis.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 pt-6 w-full">
              <div className="glass-card p-4 rounded-xl">
                ...
                <h3 className="text-[12px] leading-[16px] tracking-[0.01em] font-500">
          ...
          <div className="absolute bottom-12 left-12 text-white/40 text-[12px] leading-[16px] tracking-[0.01em] font-500">
            © 2026 Sistem Reservasi Laboratorium. Kelompok 11.
          </div>
        </section>
        ...
        <section className="w-full md:w-1/2 flex items-center justify-center p-6 min-h-screen bg-[#eff4ff]">
          <div className="w-full max-w-md">
            ...
            <div className="md:hidden flex flex-col items-center mb-8 text-center">
              ...
              <h1 className="text-[28px] leading-[36px] tracking-[-0.01em] font-600 text-[#1a146b]">
                LabSystem
              </h1>
            </div>
            ...
            <div className="shadow-sm rounded-xl p-8 w-full border bg-white border-[#c8c5d3]">
              ...
              <div className="flex mb-6 border-b border-[#c8c5d3]">
                <button
                  ...
                  className={`flex-1 py-3 border-b-2 transition-all text-center cursor-pointer text-[16px] leading-[24px] font-600 ${
                    activeTab === "login"
                      ? "border-[#1a146b] text-[#1a146b]"
                      : "border-transparent text-[#777682]"
                  }`}
              ...
              {message && (
                <div
                  className={`p-3 rounded-lg mb-4 text-sm font-500 border ${
              ...
              {activeTab === "login" && (
                <form className="space-y-4" onSubmit={handleLogin}>
                  <div className="space-y-1">
                    <label className="block text-[12px] leading-[16px] tracking-[0.01em] font-500 text-[#474651]">
                      Email
                    </label>
                    <div className="relative w-full">
                      <Mail
                        size={16}
                        className="absolute left-3 top-1/2 -translate-y-1/2 text-[#777682]"
                      />
                      <input
                        required
                  ...
                  <div className="flex items-center justify-between w-full pt-1">
                    <label className="flex items-center cursor-pointer group">
                      <input
                        className="w-4 h-4 rounded border-[#c8c5d3]"
                        type="checkbox"
                      />
                      <span className="ml-2 transition-colors text-[14px] leading-[20px] font-400 text-[#474651]">
                        Ingat Saya
                      </span>
                    </label>
                    <a
                      className="hover:underline text-[12px] leading-[16px] tracking-[0.01em] font-500 text-[#4648d4]"
                      href="#"
                    >
                      Lupa Password?
                    </a>
              ...
              {activeTab === "register" && (
                <form className="space-y-4" onSubmit={handleRegister}>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="relative w-full">
                        ...
                        <ChevronDown
                          size={16}
                          className="absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none text-[#777682]"
                        />
                      </div>
                    </div>
                  </div>
                  ...
                  <p className="text-[11px] leading-[14px] font-600 text-[#474651]">
                    ...
                    <a className="hover:underline text-[#1a146b]" href="#">
                      Syarat & Ketentuan
                    </a>{" "}
                    serta{" "}
                    <a className="hover:underline text-[#1a146b]" href="#">
